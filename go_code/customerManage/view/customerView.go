...
import (
	...
	"go_bas/go_code/customerManage/service"
)
...
func (this *customerView) list() {
	...
	for i := 0; i < len(customers); i++ {
		// fmt.Println(customers[i].Id,"\t",customers[i].Name....) //这种写法太落后了
		fmt.Println(customers[i].GetInfo())
	}
	fmt.Printf("\n-------------------------客户列表完成-------------------------\n\n")
}

// 等到用户的输入 信息构建新的用户， 并完成添加
