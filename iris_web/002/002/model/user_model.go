...
// UserToRespDesc  将数据库查询出来的结果进行格式组装成request请求需要的json字段格式
...
func (user *User) UserToRespDesc() interface{} {
	respInfo := map[string]interface{}{
		...
		"city":         user.CityName,
		"registe_time": utils.FormatDatetime(user.RegisteTime),
		"mobile":       user.Mobile,
